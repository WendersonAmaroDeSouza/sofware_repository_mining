...
def get_filtred_repository_metadatas(df_repository_metadatas):
    ...
    df_repository_metadatas['year'] = df_repository_metadatas['author_date'].apply(lambda x : x.year )
    df_repository_metadatas['month'] = df_repository_metadatas['author_date'].apply(lambda x : x.month )
    ...
    df_repository_metadatas = df_repository_metadatas[['year', 'month', 'repository_category', 'project_name', 'dmm_unit_complexity_value', 'complexity_value', 'contribuitors_number']].sort_values(by=['project_name', 'year', 'month'])

    return df_repository_metadatas

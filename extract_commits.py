...
for category in categories:
    ...
    for repository in repositories:
        ...
        print(df_repositories_metadatas['project_name'][0])
    df_repositories_dataset = pd.concat([df_repositories_dataset, get_filtred_repository_metadatas(df_repositories_metadatas)])
    print(category)
